...
/*   Updated: 2022/05/23 14:36:31 by rgelin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(Form &src) {
	try {
		...
		std::cerr << "Bureaucrat " << this->_name << " coudln't sign " << src.getName() << " form because: " << e.what() << std::endl;
	}
}
...
void	Bureaucrat::executeForm(Form const &src) const {
	try {
		...
		std::cerr << "Bureaucrat " << this->_name << " coudln't execute " << src.getName() << " form because: " << e.what() << std::endl;
	}
}
